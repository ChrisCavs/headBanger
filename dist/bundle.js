...
var Key = function (_React$Component) {
  ...
  function Key() {
    ...
    return _ret = (_temp = (_this = _possibleConstructorReturn(this, (_ref = Key.__proto__ || Object.getPrototypeOf(Key)).call.apply(_ref, [this].concat(args))), _this), _this.state = {
      ...
      if (!window.pause && event.key === _this.state.keyTag) {
        _this.play();
      }
    }, _this.play = function () {
...
exports.default = (_kick$snare$tom$tom$h = {
  ...
  tom: ['acoustic-tom-1', 'acoustic-tom-2', 'electric-tom-1', 'electric-tom-2', 'vinyl-tom-1', 'vinyl-tom-2']
}, _defineProperty(_kick$snare$tom$tom$h, 'tom', ['acoustic-tom-1', 'acoustic-tom-2', 'electric-tom-1', 'electric-tom-2', 'vinyl-tom-1', 'vinyl-tom-2']), _defineProperty(_kick$snare$tom$tom$h, 'hi-hat', ['acoustic-hi-hat-1', 'acoustic-hi-hat-2', 'electric-hi-hat-1', 'electric-hi-hat-2', 'vinyl-hi-hat-1', 'vinyl-hi-hat-2']), _defineProperty(_kick$snare$tom$tom$h, 'open-hat', ['acoustic-open-hat-1', 'acoustic-open-hat-2', 'electric-open-hat-1', 'electric-open-hat-2', 'vinyl-open-hat-1', 'vinyl-open-hat-2']), _defineProperty(_kick$snare$tom$tom$h, 'symbol', ['acoustic-cymbal-1', 'acoustic-cymbal-2', 'electric-cymbal-1', 'electric-cymbal-2', 'vinyl-cymbal-1', 'vinyl-cymbal-2']), _defineProperty(_kick$snare$tom$tom$h, 'clap', ['clap-1', 'clap-2', 'clap-3', 'clap-4', 'clap-5']), _defineProperty(_kick$snare$tom$tom$h, 'fx', ['fx-1', 'fx-2', 'fx-3', 'fx-4']), _kick$snare$tom$tom$h);
